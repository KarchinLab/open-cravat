...
Please see [our blog post](https://www.opencravat.org/announcing-the-opencravat-mcp-server/), or [the repo](https://github.com/KarchinLab/oc-mcp) to get started connecting OpenCRAVAT to the LLM of your choice.
